...
def init_w(b, d, sl, nt, wi, wo, bg, dm):
    global _bp, _all_data, _seq_len, _n_train, _W_in, _W_out, _bigram, _decay_mode
...
def run_config(name, decay_mode, bp, ALL_DATA, bigram, eval_seqs, H, W_in, W_out,
    ...
    pool = Pool(n_workers, initializer=init_w,
                initargs=(bp, ALL_DATA, 200, 2, W_in, W_out, bigram, decay_mode))
    try:
