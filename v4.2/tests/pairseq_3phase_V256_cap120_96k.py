"""3-phase V=256 with optimal cap=V*120, seed 42, budget=96k.
Applies best V=128 config to V=256.
Baselines: 2-phase V=256 cap80 96k=40.8%, 3-phase V=256 cap80 48k=29.5%"""
import sys, os, time
...
V = 256
CAP = V * 120  # 30720 (optimal from exp 15)
BUDGET = 96000
seed = 42

print(f"3-phase pair-seq V={V}, cap={CAP} (ratio=120), seed={seed}, budget={BUDGET}")
print(f"Baselines: 2-phase@cap80@96k=40.8%, 3-phase@cap80@48k=29.5%")
