"""3-phase pair-seq V=128, cap=10240, seed 42, budget=96k.
Can 3-phase break 55%? 2-phase@96k was 52.3%, 3-phase@48k matched it."""
import sys, os, time
...
print(f"Records: 2-phase@96k=52.3%, 3-phase@48k=52.3%")
