...
Current evidence anchor: E136B assistant-text route composition and boundary confirm (post-v6.1.7 main)
...
2. Run E136C assistant-text multi-turn route state and latency compare before claiming that E136B route composition transfers into a broader assistant loop or has a real latency advantage.
3. Run a later open-domain/production boundary probe before claiming broader assistant readiness.
