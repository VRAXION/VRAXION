...
Current evidence anchor: E136A assistant-text skill farm mutation/prune Orange cycle (post-v6.1.7 main)
...
2. Run E136B assistant-text route composition and boundary confirmation before claiming that the E136A assistant/text operators compose into broader assistant behavior.
3. Run a later route transfer/latency compare before claiming the E135 dialogue-state route behavior transfers to a broader assistant loop or has a real latency advantage.
