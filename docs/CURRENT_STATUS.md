...
Current evidence anchor: E136K operator replacement apply plan or Flow-scale transfer (post-v6.1.7 main)
...
2. Run E136L runtime replacement canary and tightened challenger confirmation before any destructive runtime replacement.
