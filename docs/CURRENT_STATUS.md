...
Current evidence anchor: E136C assistant-text polished render quick test (post-v6.1.7 main)
...
2. Run E136D assistant-text render training set and heldout confirmation before claiming robust text generation beyond the 12-sample quick smoke.
3. Run a later multi-turn route state/latency compare before claiming that E136B/E136C behavior transfers into a broader assistant loop or has a real latency advantage.
