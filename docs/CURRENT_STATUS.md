...
Current evidence anchor: E136D OutputTextField binary matrix smoke (post-v6.1.7 main)
...
2. Run E136E OutputTextField route-render integration before claiming the E136C rendered responses flow through the binary output field end to end.
