...
A-HiddenNatural16 is the A_v2 research lead, not yet the shipped A-block.
```
...
| `A-HiddenNatural16` | D21J | Hidden-only non-copy natural A | 100% | +2.5 | 0.777 | 37 hidden / 29 effective | **A_v2 research winner** |
...
Improve next:
  A-HiddenNatural16 margin polish
```
...
```text
1. A-HiddenNatural16 margin polish
   Goal: keep non-copy geometry, raise margin from +2.5 toward +4.0.
