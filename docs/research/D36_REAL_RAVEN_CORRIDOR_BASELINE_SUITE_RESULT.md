...
## Dataset invariant requirements and outcome
- duplicate_target_pocket_rate must be 0.0; measured smoke outcome = 0.0
- missing_target_pocket_rate must be 0.0; measured smoke outcome = 0.0
- expected_selected_points_to_target_rate must be 1.0; measured smoke outcome = 1.0
- ood_label_rule_changed must be false; measured smoke outcome = false
