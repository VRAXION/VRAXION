...
```powershell
python private_probe_runner_removed --out target/pilot_wave/e129_arithmetic_trace_orange_legendary_probation --sample-out archived_public_artifact_sample_removed
```
