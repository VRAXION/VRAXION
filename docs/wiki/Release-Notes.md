...
- **Theta bit-width Pareto frontier** — binary[1,15]=10.1%/32B, 5-val[1,2,4,7,13]=13.5%/96B, int4[1-15]=15.6%/128B. Float32 dominated (13.5%/1024B = same as 5-val at 10x cost). Range matters more than levels: [1-7] 7 levels=7.1% < [1,15] 2 levels=10.1%.
