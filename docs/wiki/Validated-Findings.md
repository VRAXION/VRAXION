...
| Theta Pareto frontier | Validated finding | binary[1,15]=`10.1%`/32B, ternary[1,7,15]=`12.1%`/64B, 5-val=`13.5%`/96B, int4=`15.6%`/128B. Int8[1-255]=`7.1%` (lazy mode, 96% never fire). Float32 DOMINATED. Range>levels. Testing [1,6,10] and [1,6,10,15]. | `sweep_theta_bits.py` |
