"""
No-Backprop v20e — Leaky ReLU Self-Wiring Graph — 64-CLASS SCALE TEST
======================================================================
Can the architecture scale? 64 classes, 320 neurons.
leaky_relu activation, same self-wiring as v18.
Solved = accuracy 100%.
"""
...
app = modal.App("vraxion-v20e-64class")
...
def run_experiment():
    ...
    print(f"v20e Leaky ReLU — 64-CLASS SCALE TEST")
    print(f"=" * 60)
    ...
    for attempt in range(max_attempts):
        ...
        if (attempt + 1) % 2000 == 0:
            ...
            # BOTH trigger 2: acc 100% but score low
    ...
    print(f"\n  Compare:")
    print(f"  v18  relu  32-class: 100% at ~10k")
    print(f"  v20e leaky 32-class: 100% at ~8k")
    print(f"  v20e leaky 64-class: {final_acc*100:.0f}%")
...
def main():
    print("Running v20e leaky_relu 64-class scale test...")
