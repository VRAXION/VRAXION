...
def run_phase_b_cell(
    ...
    if phase in {"D2", "D3", "D3F", "D4", "D7", "D8"}:
...
def main() -> int:
    args = parse_args()
    if sum([args.phase_b, args.phase_b1, args.phase_d1, args.phase_d2, args.phase_d3_klock, args.phase_d3_fine_k, args.phase_d4_softness, args.phase_d7_bandit, args.phase_d8_instrumentation]) > 1:
        raise SystemExit("--phase-b, --phase-b1, --phase-d1, --phase-d2, --phase-d3-klock, --phase-d3-fine-k, --phase-d4-softness, --phase-d7-bandit, and --phase-d8-instrumentation are mutually exclusive")
    if args.phase_b:
