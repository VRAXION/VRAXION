#!/usr/bin/env python3
"""Checker for D67 Rust sparse support scoring scale confirm."""
...
def main():
    ...
    parser.add_argument("--out", default="target/pilot_wave/d67_rust_sparse_support_scoring_scale_confirm/smoke")
