...
def main() -> int:
    ...
    out = Path(args.out)
    payload = build_payload(e109, e110, e111, e112, e114, e116, e117, e118, e120, e121, e122, e127, e129, e130a, e130b, e131)
