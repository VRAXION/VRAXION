"""
Test AdamW optimizer on TRUE Möbius (mobius=True).

AdamW = Adam with decoupled weight decay
- Industry standard upgrade over Adam
- Better generalization
- Used in GPT, BERT, most modern models

Compare to Adam baseline (75% with oscillations).
"""
...
def main():
    ...
    print("=" * 70)
    print("DIAMOND CODE - AdamW on TRUE MÖBIUS")
    print("=" * 70)
    ...
    print(f"Topology: TRUE Möbius (mobius=True)")
    print()
    ...
    # Log file
    log_path = Path(__file__).parent / "logs" / "diamond" / "adamw_mobius.log"
    ...
    log("=" * 70)
    log(f"AdamW Test (Möbius): {num_keys} keys, {num_pairs} pairs, len={seq_len}")
