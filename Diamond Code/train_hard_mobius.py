"""
Hard Task Test - TRUE Möbius

Task: 4 keys, 4 pairs, seq_len=64
This is 4× harder than baseline (2 keys, 2 pairs, seq_len=32)

If Möbius doubles memory capacity via holonomy, it should
outperform standard ring on this memory-intensive task.
"""
...
def main():
    ...
    print("=" * 70)
    print("HARD TASK TEST - TRUE MÖBIUS")
    print("=" * 70)
    ...
    print(f"Topology: TRUE Möbius (holonomy memory doubling)")
    print()
    print("Hypothesis: Möbius should outperform Standard on hard tasks")
    print("Reason: Holonomy doubles effective memory capacity")
    print()
    ...
    # Log file
    log_path = Path(__file__).parent / "logs" / "diamond" / "hard_mobius.log"
    ...
    try:
        # Run for 3000 steps (harder task needs more training)
        while step < 3000:
