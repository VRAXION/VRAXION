...
pub(crate) const MAX_CHARGE: u32 = 15;
...
pub(crate) const DEFAULT_FIRING_THRESHOLD: u32 = 6;
...
pub(crate) const INHIBITORY_PERCENT: u32 = 10;
...
pub(crate) const WAVE_CHANNEL_COUNT: usize = 8;
...
pub(crate) const WAVE_TICKS_PER_PERIOD: usize = 8;
...
pub(crate) const WAVE_AMPLITUDE_PERMILLE: u32 = 300;
...
pub(crate) const DEFAULT_TICKS_PER_TOKEN: usize = 12;
...
pub(crate) const DEFAULT_INPUT_DURATION: usize = 2;
...
pub(crate) const DEFAULT_CHARGE_DECAY_PERIOD: usize = 6;
...
pub(crate) const DEFAULT_INITIAL_DENSITY_PERCENT: u32 = 5;
...
/// PHI ≈ 1618/1000 = 1.618
pub(crate) const PHI_NUMERATOR: u32 = 1618;
pub(crate) const PHI_DENOMINATOR: u32 = 1000;
...
pub(crate) const SDR_ACTIVE_PERCENT: u32 = 20;
