...
fn main() {
    ...
    println!(
        "{{\"passed\":{},\"lanes\":{},\"rounds_per_lane\":{},\"total_rounds\":{},\"global_generated_pocket_count\":{},\"duplicate_candidates_blocked\":{},\"failed_promotions\":{},\"redundant_clone_block_rate\":{:.6},\"bad_commit_rate\":{:.6},\"unsafe_promotion_rate\":{:.6},\"seconds\":{:.9},\"out\":\"{}\",\"global_supervisor_out\":\"{}\"}}",
        summary.passed,
        summary.lanes,
