# run_tier2_8_3_signal.ps1
# Tier 2.8.x: reward/pain inertia signal (ratchet disabled)
...
$env:VAR_LOGGING_PATH = "logs/sanity_tier2_8_3_signal.log"

# Replace ratchet with reward/pain signal
...
$env:TP6_INERTIA_SIGNAL_REWARD = "0.1"
$env:TP6_INERTIA_SIGNAL_PAIN = "0.05"
