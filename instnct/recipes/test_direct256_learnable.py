"""
Direct 256 output with learnable theta — H=384
================================================
64 SDR in + 256 direct out + 64 hidden. Learnable theta.
The one test we never ran with proper theta.
"""
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*60}")
    print(f"  DIRECT 256 OUTPUT — learnable theta")
