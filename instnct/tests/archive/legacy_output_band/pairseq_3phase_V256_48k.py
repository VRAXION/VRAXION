"""3-phase pair-seq at V=256, cap=20480, seed 42, budget=48k.
Tests whether rewire helps at V=256 like it does at V=128 (+6.4%).
Compare vs 2-phase baseline (exp 9: 31.3% at 48k)."""
import sys, os, time
...
print(f"3-phase pair-seq V={V}, cap={CAP}, seed={seed}, budget={BUDGET}")
print(f"2-phase baseline (exp 9): 31.3% at 48k")
...
print(f"vs 2-phase baseline: 31.3% → {best*100:.1f}% ({(best-0.313)*100:+.1f}%)")
