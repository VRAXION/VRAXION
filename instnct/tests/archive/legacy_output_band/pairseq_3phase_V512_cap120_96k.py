"""3-phase V=512 with optimal cap=V*120, seed 42, budget=96k.
Tests scaling law at V=512. Expected ~30-35% based on trajectory.
V=256@96k=49.5%, V=128@96k=52.7%."""
import sys, os, time
...
wset_kb = (3 * V * V*3 * 4 + CAP * 12) / 1024
print(f"Working set: ~{wset_kb:.0f}KB ({wset_kb/1024:.1f}MB)")
